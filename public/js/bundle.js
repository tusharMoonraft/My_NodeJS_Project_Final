...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"tourCreate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tourCreate = void 0;
...
var tourCreate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, ratingsQuantity, ratingsAverage, maxGroupSize, price, duration, summary, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function tourCreate(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref.apply(this, arguments);
  };
}();
...
var _tourCreate = require("./tourCreate");
...
var createTourForm = document.querySelector('.form--tourCreate');
...
if (createTourForm) {
  createTourForm.addEventListener('submit', function (e) {
    ...
    var ratingsQuantity = document.getElementById('ratingsQuantity').value;
    var ratingsAverage = document.getElementById('ratingsAverage').value;
    var maxGroupSize = document.getElementById('price').value;
    ...
    e.preventDefault();
    (0, _tourCreate.tourCreate)(name, ratingsQuantity, ratingsAverage, maxGroupSize, price, duration, summary, description);
  });
}
